export const WeatherCard = ({ fecha, minTemp, maxTemp, icon, meassure }) => {
  ...
  return (
    <div className="w-[45%] lg:py-6 sm:min-h-[250px] xl:max-w-[160px] lg:w-[16%] lg:max-w-[120px] py-3 lg:px-2 px-6 lg:min-h-[150px] xl:min-h-[180px] xl:min-w-[100px] xl:px-4 xl:w-[15%] xl:h-[20px] min-h-[250px] text-center content-center flex-col bg-normal text-textoClaro">
      <span className="h-[15%] lg:text-[14px] xl:text-[13px] text-[16px] ">{fecha}</span>
      <div className="w-[100%] flex flex-col justify-center items-center h-[70%] ">
      <img className="h-auto w-[90%] " src={`/weather/${icon}.svg`} />
      </div>
